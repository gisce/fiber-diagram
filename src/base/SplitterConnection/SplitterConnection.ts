...
import { SplitterConnectionApiType, SplitterConnectionDataType } from ".";

export class SplitterConnection {
  fiber_in: number;
  fiber_out: number;
  parentGrid: Grid;
  legs: LegType[] = [];
  ...
  onInitializeDone?: (connection: SplitterConnection) => void;
  ...
  constructor({
    ...
    data: SplitterConnectionDataType;
    parentGrid: Grid;
    onInitializeDone?: (connection: SplitterConnection) => void;
  }) {
  ...
  remove() {
    this.parentGrid.removeSplitterConnection(this);
  }

  getApiJson(): SplitterConnectionApiType {
  ...
  getJson(): SplitterConnectionDataType {
    const { fiber_in, fiber_out } = this;
    return {
      fiber_in,
      fiber_out,
